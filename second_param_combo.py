...
param = "pseudo"
output = 'mass_concentration_fit_m20.h5'
...
def _get_lnprior(theta):
    a,logMmin,sigma_logM,alpha,logM0,logM1 = theta
    if -0.325 < a < 0.325 and 10.0 < logMmin < 15.0 and 0.0 < sigma_logM < 3.0 and 0.0 < alpha < 4.0 and 10.0 < logM0 < 15.0 and 10.0 < logM1 < 15.0:
        return 0.0
    return -np.inf
