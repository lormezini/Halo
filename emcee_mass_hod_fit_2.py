...
for i in range(3):
    plt.plot(sampler.chain[i+50,50:100,0],c= c[-i])
    #plt.ylim(150,250)
plt.yscale('log')
plt.xlabel('step')
plt.ylabel('logMmin')
plt.savefig('logMmin_v_step.png')
c = ['#fee8c8','#fdbb84','#e34a33']
for i in range(3):
    plt.plot(sampler.chain[i+50,50:100,1],c= c[-i])
    #plt.ylim(150,250)                                                          
plt.yscale('log')
plt.xlabel('step')
plt.ylabel('sigma_logM')
plt.savefig('sigmalogM_v_step.png')

c = ['#fee8c8','#fdbb84','#e34a33']
for i in range(3):
    plt.plot(sampler.chain[i+50,50:100,2],c= c[-i])
    #plt.ylim(150,250)                                                          
plt.yscale('log')
plt.xlabel('step')
plt.ylabel('alpha')
plt.savefig('alpha_v_step.png')

c = ['#fee8c8','#fdbb84','#e34a33']
for i in range(3):
    plt.plot(sampler.chain[i+50,50:100,3],c= c[-i])
    #plt.ylim(150,250)                                                          
plt.yscale('log')
plt.xlabel('step')
plt.ylabel('logM0')
plt.savefig('logM0_v_step.png')

c = ['#fee8c8','#fdbb84','#e34a33']
for i in range(3):
    plt.plot(sampler.chain[i+50,50:100,4],c= c[-i])
    #plt.ylim(150,250)                                                          
plt.yscale('log')
plt.xlabel('step')
plt.ylabel('logM1')
plt.savefig('logM1_v_step.png')
